...
/** Forge implementation of BuildCraft's internal runtime boundary. */
public final class ForgeRuntimePlatform implements RuntimePlatform {
    public static final ForgeRuntimePlatform INSTANCE = new ForgeRuntimePlatform();
