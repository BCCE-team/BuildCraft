...
public abstract class BCLibProxy {
    ...
    static void MessageRegistry() {
        ...
        MessageManager.registerMessageClass(
            BCModules.LIB,
            buildcraft.lib.net.MessageGuideRecipeDisplays.class,
            buildcraft.lib.net.MessageGuideRecipeDisplays.HANDLER,
            buildcraft.lib.net.MessageGuideRecipeDisplays::toBytes,
            buildcraft.lib.net.MessageGuideRecipeDisplays::new,
            Dist.CLIENT
        );
    }
    ...
    public static Player getClientPlayer() {
        return FMLEnvironment.getDist() == Dist.CLIENT ? ClientAccess.getPlayer() : null;
    }
    ...
    public InputStream getStreamForIdentifier(Identifier identifier) throws IOException {
        return null;
    }
