...
public final class GuiUtil {
    ...
    public static void drawItemStackAt(ItemStack stack, GuiGraphics guiGraphics, int x, int y) {
        // GuiGraphics owns the 1.21.11 item render state and lighting/depth setup.
    ...
    public static int drawHoveringText(GuiGraphics guiGraphics, List<Component> textLines, int mouseX, int mouseY,
        ...
        // Deferred GuiGraphics rendering replaces legacy Z translation with an explicit stratum.
    ...
    public static void drawTexturedModalRect(GuiGraphics guiGraphics, Identifier texture, double posX,
    ...
    private static void applyScissor() {
        ...
        RenderCompat.enableScissor(x, y, (int) (total.width * scale), (int) (total.height * scale));
    }
    ...
    public static final class WrappedTextData {
        ...
        public void drawAt(GuiGraphics guiGraphics, int x, int y, int colour, boolean centered) {
            ...
            for (FormattedCharSequence line : lines) {
                ...
                guiGraphics.drawString(renderer, line, lineX, drawY, buildcraft.lib.client.sprite.GuiSpriteRender121111.opaqueRgb(colour), shadow);
