...
public class ItemTransactorHelper {
    ...
    public static IItemTransactor getTransactor(Level level, BlockPos pos, Direction face, @Nullable BlockEntity provider) {
        ...
        if (trans != null && !buildcraft.lib.compat.transfer.TransferJournal.active()) {
            return trans;
        }

        if (provider != null && !buildcraft.lib.compat.transfer.TransferJournal.active()) {
        ...
        if (buildcraft.lib.compat.transfer.TransferJournal.active()) return NoSpaceTransactor.INSTANCE;
    ...
    public static IItemTransactor getTransactorForEntity(Entity entity, Direction face) {
        ...
        if (transactor != null && !buildcraft.lib.compat.transfer.TransferJournal.active()) {
            return transactor;
        }
