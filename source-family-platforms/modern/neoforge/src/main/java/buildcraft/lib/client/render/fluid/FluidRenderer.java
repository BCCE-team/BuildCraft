...
public class FluidRenderer {
    ...
    public static void onTextureStitchPost(ClientAtlas.After event) {
        ...
        for (Fluid fluid : BuiltInRegistries.FLUID) {
            ...
            Identifier still = extensions.getStillTexture();
            Identifier flowing = extensions.getFlowingTexture();
...
//        vertex.colouri(RenderUtil.swapARGBforABGR(fluid.getFluid()));
     ...
     * so tile the atlas sprite through GuiGraphics instead of immediate BufferBuilder rendering. */
    ...
    private static void drawFluidForGuiNative(TextureAtlasSprite fluidSprite, int tint, double startX, double startY,
        double endX, double endY, GuiGraphics guiGraphics) {
        if (fluidSprite == null) {
