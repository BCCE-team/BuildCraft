...
public class BCTransport {
    ...
    private void registerCapabilities(RegisterCapabilitiesEvent event) {
        ...
        event.registerBlockEntity(net.neoforged.neoforge.capabilities.Capabilities.Item.BLOCK, pipeHolderType,
        ...
        BCCapabilityRegistration.registerBlockEntity(
            event, CapUtil.CAP_ITEMS, BCTransportBlocks.FILTERREDBUFFER_BE.get()
        );
    }
