...
public final class MjToFeAutoConverter implements IMjReceiver, IMjReadable {
    ...
    @Override
    public long getStored() { return BuildCraftApi.service(BuildCraftServices.ENERGY).conversion().feToMicroMj(fe.getEnergyStored()); }

    @Override
    public long getCapacity() { return BuildCraftApi.service(BuildCraftServices.ENERGY).conversion().feToMicroMj(fe.getMaxEnergyStored()); }
}
