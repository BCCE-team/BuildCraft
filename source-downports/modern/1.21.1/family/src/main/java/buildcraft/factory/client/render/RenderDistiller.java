...
public class RenderDistiller implements BCGeometryRenderer<TileDistiller_BC8> {
	...
	@Override
	public void renderContents(TileDistiller_BC8 tile, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int combinedLight,
			int overlay) {
        ...
        // buffer setup
        {
            ...
            VertexConsumer fluidBuffer = buffer.getBuffer(BCRenderTypes.translucent());
