...
public class RenderBuilder implements BlockEntityRenderer<TileBuilder>, LegacyLaserBlockEntityRenderer<TileBuilder> {
    ...
    @Override
    public void renderLasers(@Nonnull TileBuilder tile, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int light, int overlay) {
