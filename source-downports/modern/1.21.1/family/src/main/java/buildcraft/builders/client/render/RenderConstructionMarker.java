...
public class RenderConstructionMarker implements BlockEntityRenderer<TileConstructionMarker>, LegacyLaserBlockEntityRenderer<TileConstructionMarker> {
    ...
    @Override
    public void renderLasers(@Nonnull TileConstructionMarker tile, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int light, int overlay) {
        matrix.pushPose();
