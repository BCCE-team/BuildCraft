...
public class GuiEngineIron_BC8 extends GuiBC8<ContainerEngineIron_BC8> {
    ...
    public void init() {
        ...
        mainGui.shownElements.add(new GuiElementFluidTank(container.widgetTankFuel, mainGui, new GuiRectangle(26, 18, 16, 60).offset(mainGui.rootElement), ICON_TANK_OVERLAY));
        mainGui.shownElements.add(new GuiElementFluidTank(container.widgetTankCoolant, mainGui, new GuiRectangle(80, 18, 16, 60).offset(mainGui.rootElement), ICON_TANK_OVERLAY));
        mainGui.shownElements.add(new GuiElementFluidTank(container.widgetTankResidue, mainGui, new GuiRectangle(134, 18, 16, 60).offset(mainGui.rootElement), ICON_TANK_OVERLAY));
    }
