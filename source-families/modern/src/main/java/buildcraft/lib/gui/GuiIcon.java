...
public class GuiIcon implements ISimpleDrawable{
    ...
    public void drawScaledInside(GuiGraphics guiGraphics, IGuiArea element) {
    ...
    public void drawCutInside(GuiGraphics guiGraphics, IGuiArea element) {
    ...
    public static void drawAt(GuiGraphics guiGraphics, ISprite sprite, double x, double y, double width, double height) {
