...
public final class NBTUtilBC {
    ...
    /**
     * Returns a copy of the stack's custom-data component. Mutations must be
     * committed with {@link ItemStackUtil#setCustomData(ItemStack, CompoundTag)}.
     */
    @Deprecated
    public static CompoundTag getItemData(@Nonnull ItemStack stack) {
        return stack.isEmpty() ? new CompoundTag() : ItemStackUtil.getCustomData(stack);
    }
