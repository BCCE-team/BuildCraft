...
public class LaserRenderer_BC8 {
    ...
    static {
        ...
        COMPILED_STATIC_CPU_LASERS = CacheBuilder.newBuilder()//
            .expireAfterWrite(5, TimeUnit.SECONDS)//
            .build(CacheLoader.from(LaserRenderer_BC8::makeStaticLaserBuffer));
        ...
        FORMAT_LESS = DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP;
        FORMAT_ALL = DefaultVertexFormat.BLOCK;
     ...
     * buffers already contain atlas-generation-specific UVs. Keeping stale buffers after a resource
    ...
    public static void clearModels() {
        ...
        COMPILED_STATIC_CPU_LASERS.cleanUp();
    ...
    private static LaserCompiledBuffer makeStaticLaserBuffer(LaserData_BC8 data) {
