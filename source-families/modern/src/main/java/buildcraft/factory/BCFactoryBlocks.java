...
public class BCFactoryBlocks {
    public static final BCDeferredRegister<BlockEntityType<?>> BLOCK_ENTITYS =
        BCDeferredRegister.create("minecraft:block_entity_type", BCFactory.MODID);
    public static final BCDeferredRegister<Block> BLOCKS =
        BCDeferredRegister.create("minecraft:block", BCFactory.MODID);
    ...
    public static final BCRegistryEntry<BlockMiningWell> MINING_WELL_BLOCK =
        BLOCKS.register("mining_well", BlockMiningWell::new);
    public static final BCRegistryEntry<BlockDistiller> DISTILLER_BLOCK =
        BLOCKS.register("distiller", BlockDistiller::new);
    public static final BCRegistryEntry<BlockHeatExchange> HEATEXCHANGE_BLOCK =
        BLOCKS.register("heat_exchange", BlockHeatExchange::new);
    public static final BCRegistryEntry<BlockWaterGel> WATER_GEL = BLOCKS.register("water_gel", BlockWaterGel::new);
    public static final BCRegistryEntry<BlockAutoWorkbenchItems> AUTO_BENCH_BLOCK =
        BLOCKS.register("autoworkbench_item", BlockAutoWorkbenchItems::new);

    public static final BCRegistryEntry<BlockEntityType<TileTank>> ENTITYBLOCKTANK =
        BLOCK_ENTITYS.register("entity_tank",
            () -> BlockEntityType.Builder.of(TileTank::new, TANK_BLOCK.get()).build(null));
    public static final BCRegistryEntry<BlockEntityType<TilePump>> ENTITYBLOCKPUMP =
        BLOCK_ENTITYS.register("entity_pump",
            () -> BlockEntityType.Builder.of(TilePump::new, PUMP_BLOCK.get()).build(null));
    public static final BCRegistryEntry<BlockEntityType<TileFloodGate>> ENTITYBLOCKFLOODGATE =
        BLOCK_ENTITYS.register("entity_flood_gate",
            () -> BlockEntityType.Builder.of(TileFloodGate::new, FLOOD_GATE_BLOCK.get()).build(null));
    public static final BCRegistryEntry<BlockEntityType<TileMiningWell>> ENTITYBLOCKMININGWELL =
        BLOCK_ENTITYS.register("entity_mining_well",
            () -> BlockEntityType.Builder.of(TileMiningWell::new, MINING_WELL_BLOCK.get()).build(null));
    public static final BCRegistryEntry<BlockEntityType<TileDistiller_BC8>> ENTITYBLOCKDISTILLER =
        BLOCK_ENTITYS.register("entity_distiller",
            () -> BlockEntityType.Builder.of(TileDistiller_BC8::new, DISTILLER_BLOCK.get()).build(null));
    public static final BCRegistryEntry<BlockEntityType<TileHeatExchange>> ENTITYBLOCKHEATEXCHANGE =
    ...
    public static final BCRegistryEntry<BlockEntityType<TileAutoWorkbenchItems>> ENTITYBLOCKAUTOBENCH =
