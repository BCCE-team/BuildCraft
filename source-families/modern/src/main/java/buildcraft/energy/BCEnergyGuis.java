...
public class BCEnergyGuis {
    public static final BCRegistryEntry<MenuType<ContainerEngineStone_BC8>> MENU_STONE =
        BCEnergy.MENUS.register(
            "engine_stone_menu", () -> BCContainerFactory.create(ContainerEngineStone_BC8::new)
        );
    public static final BCRegistryEntry<MenuType<ContainerEngineIron_BC8>> MENU_IRON =
        BCEnergy.MENUS.register(
            "engine_iron_menu", () -> BCContainerFactory.create(ContainerEngineIron_BC8::new)
        );
    public static final BCRegistryEntry<MenuType<ContainerEngineFE>> MENU_FE =
        BCEnergy.MENUS.register("engine_fe_menu", () -> BCContainerFactory.create(ContainerEngineFE::new));
    public static final BCRegistryEntry<MenuType<ContainerDynamoMJ>> MENU_DYNAMO_MJ =
